...
const MarriageBiodata: React.FC = () => {
  return (
    <div
      id="biodata-content"
      className="w-full h-auto bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100"
      style={{
    ...
    >
      {/* Header with Photo */}
      <div className="relative bg-linear-to-r from-indigo-700 to-indigo-900 dark:from-indigo-950 dark:to-gray-950 text-white p-6 pb-16 sm:pb-20 md:pb-2">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center tracking-wide">
          MARRIAGE BIODATA
        </h1>

        {/* Profile Photo */}
        <div className="absolute top-4 right-4 sm:top-6 sm:right-6 w-20 h-20 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-white dark:border-gray-300 shadow-xl">
          <img
      ...
      <div className="p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8 text-sm sm:text-base">
        {/* PERSONAL DETAILS */}
        <section>
          <h2 className="text-lg sm:text-xl font-bold text-indigo-800 dark:text-indigo-300 mb-2 sm:mb-3 border-b border-indigo-200 dark:border-indigo-800/40 pb-1">
            PERSONAL DETAILS
          </h2>
